...
def fetch_route_with_rate_limit(start_coord, end_coord, api_keys):
    for api_key in api_keys:
        ...
        if response.status_code == 200:
            ...
            print(f"Rate limit exceeded for API key {api_key}. Waiting for 60 seconds...")
            ...
            break  # Move to the next API key if daily quota exceeded
        else:
...
api_keys = [
    ...
    '5b3ce3597851110001cf62484477bd2651be4e3e962535a2a57c0d6d'   # Missing API key
]
